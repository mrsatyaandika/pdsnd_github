# Final project of Introduction to Python Lesson
...
def time_stats(df):
    ...
    print('most frequent month is {}'.format(popular_month))
    print('most frequent weekday is {}'.format(popular_weekday))
    print('most frequent hour is {}'.format(popular_hour))
